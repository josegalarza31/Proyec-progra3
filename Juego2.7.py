...
# Texto y fuente 2
fuente = pygame.font.SysFont('Bauhaus 93', 30)
texto = fuente.render(cadena, True, black)
...
while run:
    ...
    # Tiempo
    pantalla.blit(texto,(300, 800))
    tiempo = pygame.time.get_ticks() / 1000
    texto = fuente.render("Tiempo Jugado: "+ str(tiempo), True, white)
    ...
    # Puntaje mas alto
    if juego_terminado == True:
        if ultimo_puntaje > mayor_puntaje:
            mayor_puntaje = ultimo_puntaje
            draw_text("Puntaje mas alto: " + " " + str(ultimo_puntaje), font, white, 250, 300)
        else:
            ultimo_puntaje = mayor_puntaje
            draw_text("Puntaje mas alto: " + " " + str(ultimo_puntaje), font, white, 250, 300)
